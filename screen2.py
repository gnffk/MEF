...
def InitGraph(window):
    ...
    SearchListbox = Listbox(listbox_frame1, font=(font_name, 10), bg='#efc376', yscrollcommand=ListBoxScrollbar1.set)
    SearchListbox.pack(side=LEFT, fill=BOTH, expand=True)

    ListBoxScrollbar1.config(command=SearchListbox.yview, bg='#efc376')
